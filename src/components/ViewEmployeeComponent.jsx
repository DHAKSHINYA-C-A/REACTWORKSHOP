                        ...
                        <div className="row">
                                ...
                                <div className="col-7">
                                        ...
                                        <div className = "row">
                                            ...
                                            <div className='ml-2'> { this.state.employee.passengerName }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Train Name : </label>
                                            <div className='ml-2'> { this.state.employee.trainName }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Seat No: </label>
                                            <div className='ml-2'> { this.state.employee.seatNo }</div>
                                        </div>
                                        <div className = "row">
                                            <label>Cost: </label>
                                            <div className='ml-2'> { this.state.employee.cost }</div>
                                        </div>
                                </div>
                        </div>
